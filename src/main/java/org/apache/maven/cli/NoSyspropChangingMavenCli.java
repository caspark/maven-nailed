// Copied from Maven 3.0.5 and modified to avoid setting system properties for -D arguments (in setCliProperty())
// (if properties are set, then -D properties like skipTests will be "remembered" between runs)
// That likely breaks SystemPropertyProfileActivator, but near as I can tell, profiles activated by properties are still
// activated correctly.
 ...
 */
public class NoSyspropChangingMavenCli
{
    ...
    public NoSyspropChangingMavenCli()
    {
        this( null );
    }

    // This supports painless invocation by the Verifier during embedded execution of the core ITs
    public NoSyspropChangingMavenCli(ClassWorld classWorld)
    {
